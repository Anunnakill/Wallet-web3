...
1. Walletconnect: onAccountsChanged(), onChainChanged()
2. Metamask: onAccountsChanged(), onChainChanged()
3. Portis: onAccountsChanged()
4. Walletlink: No (The official has not provided any monitoring events.)
